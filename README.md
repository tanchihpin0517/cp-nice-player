...
| `cp-nice-player.playback.prefetchSec` | `10` | How far ahead of the playhead the player fetches chunks, in seconds of audio, counting the current chunk. The chunk count is derived as `ceil(seconds / chunkDurationSec)`, at least 1 — at the 2 s chunk default, `10` → 5 chunks. |
